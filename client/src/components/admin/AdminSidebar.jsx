...
const AdminSidebar = () => {
  ...
  const adminNavlinks = [
    ...
    { name: "Add Theatre", path: "/admin/add-theatre", icon: Building2Icon },
    { name: "List Theatres", path: "/admin/list-theatres", icon: BuildingIcon },
  ];
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `relative flex items-center max-md:justify-center gap-2 w-full
               py-2.5 min-md:pl-10 first:mt-6 text-gray-400
